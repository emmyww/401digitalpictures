...
public interface Picture {
	...
	public int getWidth(); // y
	public int getHeight(); // x
	...
	// replaces completely
	// same thing as calling x, y, p, factor of 1 in the paint below
	// x is on left and y is on right (top), row then column
	
	public void paint(int x, int y, Pixel p, double factor);
	// factor blends color already there with p
