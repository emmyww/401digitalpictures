...
public interface Pixel {
	...
	// blend method
	// mix red pixel with blue pixel is other, factor is how much u want to blend them
	// factor of 0 doesnt blend anything, factor of 1 changes color to the "other" color
	
}

/* pictures made up of pixel objects
 * 
 * 
 * 
 * 
